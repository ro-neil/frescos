  ...
  <div class="bg-primary dark:bg-gray-900 dark:text-white">
    <div class="flex flex-col">
      ...
      <div class="flex flex-col items-center bg-gray-100 dark:bg-gray-800 w-full pt-10">
        <div class="sm:w-2xl lg:w-4xl rounded-md shadow-sm px-6 sm:px-10 md:px-18 py-8 flex flex-col items-center bg-emerald-50/25 dark:bg-gray-700 border border-emerald-100 dark:border-gray-600 mb-5!">
