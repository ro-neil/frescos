...
<template>
  <section class="section-container lg:flex-row! bg-[#FDFBF6] dark:bg-gray-800 ">
    <div class="w-full grid grid-cols-2 gap-4 sm:gap-6">
      <div class="col-span-1 aspect-square overflow-hidden rounded-full shadow-lg shadow-orange-400 hover-scale-2">
